...
export async function getMatches(_filters: MatchFilters): Promise<ServiceResult<Match[]>> {
...
export async function createMatch(_input: CreateMatchInput): Promise<ServiceResult<Match>> {
...
export async function cancelMatch(_id: string): Promise<ServiceResult<Match>> {
...
export async function leaveMatch(_matchId: string, _userId: string): Promise<ServiceResult<null>> {
