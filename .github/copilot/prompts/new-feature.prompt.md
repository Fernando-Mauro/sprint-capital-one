...
I need to implement a new feature for Altheia.
...
4. What UI/styling work is needed? (UI Design Expert)
5. What security considerations exist? (Security & RLS Agent)
6. What tests should be written? (Testing Agent)
7. What documentation updates are needed? (Documentation Agent)

Provide the full delegation plan with handoff prompts for each agent.
